...
// Part 6
// Generic block of code for processing an array of sides arrays
...
for (const sides of data) {
  ...
  if (description.length > 0) {
    console.log(
      `${description} with sides ${sides.toString()} has perimeter of ${shape.perimeter()} and area of ${shape.area()}`
    );
  } else {
    if (sides.length === 1) {
